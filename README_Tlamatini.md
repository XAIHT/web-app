...
<p align="center">
  ...
  Frontier plans like GPT-5.4 or Claude Opus cost about <b>$200 per month</b>. <b>Tlamatini is free and open-source</b> — your only bill is <b>Ollama Pro (~$200 a <i>year</i>, paid to Ollama, not us)</b>, and on top of it she stacks <b>83 agent types and 75+ tools</b>: comparable power for about <b>one twelfth</b> the price, all on your own machine.
</p>
...
<p align="center">
  ...
  <a href="https://github.com/XAIHT/Tlamatini/releases/tag/v1.33.0"><img src="https://img.shields.io/badge/VERSION-v1.33.0-1E90FF?style=for-the-badge&labelColor=2D2D2D" alt="Version"/></a>
  ...
  <a href="#-the-full-capability-list"><img src="https://img.shields.io/badge/AGENT%20TYPES-83-8A2BE2?style=for-the-badge&labelColor=2D2D2D" alt="83 agent types"/></a>
...
The whole idea in one line: **don't pay $200 a month for a frontier model.** **Tlamatini is free** — your only cost is **Ollama Pro (~$200 a year, paid to Ollama, not us)**; point Tlamatini at it and drive **83 agent types and 75+ tools** from your own machine. Here's the full setup.
...
| 🧩 | **A VISUAL WORKFLOW DESIGNER** | **83 drag-and-drop agent types** on a canvas you wire into runnable, savable `.flw` flows. *No other coding agent — Claude Code, Codex, none of them — gives you this.* This is the crown jewel. |
...
- **Visual Workflow Designer (ACP)** — 83 drag-and-drop agent types wired into runnable flows; save/load `.flw` files; Flow Compiler validates the canvas into `config.yaml`.
