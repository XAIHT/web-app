...
>
> **Before that — versioned alongside the Tlamatini app.** The site tracks the product it advertises: the `/tlamatini` page mirrors the current release (v1.17.0 at time of writing — 74 agent types, 27 skills, hybrid RAG, ACPX, Unreal MCP) and its install walkthrough. Bumping the app version means refreshing the marketing copy here.
