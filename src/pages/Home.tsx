          ...
          <div className="xaiht-card">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                { label: o.stats.version, value: 'v1.44.0' },
...
function ToolsSection() {
  ...
  const toolData = [
    ...
    { name: 'STM32er: Blue Pill -> F7/G/L/H7/U5/WB', color: '#7a9e8e' },
    ...
    { name: 'Animated Avatar + Browser Voice', color: '#c79e7a' },
    { name: 'Paste / Drop Images to Chat', color: '#8a9ec7' },
    { name: 'Large Image Preview', color: '#8a9ec7' },
    { name: 'Zavuerer Unified Messaging', color: '#7a9e8e' },
    { name: 'Playwrighter', color: '#8a9ec7' },
    { name: 'Windower', color: '#c79e7a' },
    { name: 'Discoverer Long-Run', color: '#c9a96e' },
    { name: 'Kalier Long-Run', color: '#c9a96e' },
    { name: 'Nmapper Long-Run', color: '#c9a96e' },
    { name: 'Guided Prompt Catalog', color: '#b08cc7' },
    { name: '[[ User ]] / {{ Runtime }} / < Report >', color: '#b08cc7' },
    { name: 'Hard Cancel', color: '#c79e7a' },
    { name: 'Structured External-MCP Results', color: '#b08cc7' },
    { name: 'Leaner Carried Runtime', color: '#9e9e9e' },
