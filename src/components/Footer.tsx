    ...
    <footer style={{ background: '#111', borderTop: '1px solid #222' }}>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-20 text-center">
        ...
        <p className="text-[#888] mb-8 max-w-md mx-auto" style={{ fontSize: '1rem', lineHeight: 1.65 }}>
          Tlamatini v1.3.0 brings Unreal Engine-enabled project assistance, Hybrid RAG, live Config, DB, and ACPX-Skills controls, 256-turn Multi-Turn orchestration, GPU-aware context loading, ACPX delegation, 21 skills, and 62 workflow agents to one local developer assistant.
        </p>
