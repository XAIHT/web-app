    ...
    <footer style={{ background: '#111', borderTop: '1px solid #222' }}>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-20 text-center">
        ...
        <p className="text-[#888] mb-8 max-w-md mx-auto" style={{ fontSize: '1rem', lineHeight: 1.65 }}>
          Tlamatini v1.6.0 brings Unreal Engine-enabled project assistance, Hybrid RAG with high-detail embedding opt-in, live Config, DB, and ACPX-Skills controls, 73-tool Multi-Turn orchestration, GPU-aware context loading, opt-in ACPX delegation, 23 skills, and 66 workflow agents including Playwrighter, Windower, commit-aware Reviewer, and Analyzer gates to one local developer assistant.
        </p>
