...
Download the latest release ZIP — **[Tlamatini v1.17.1](https://github.com/XAIHT/Tlamatini/releases/tag/v1.17.1)** — and unzip it (or use a `Tlamatini_Release/` folder somebody handed you / you built — see Part VIII). Then:
